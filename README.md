...
- `content/index.md` is the canonical source for website copy.
- `main.js` renders the Markdown content into `index.html`.
- `llms.txt` is the machine-readable website map.
- `design/` contains the design specification and visual assets.
